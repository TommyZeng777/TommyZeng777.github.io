...
1.**新建个人博客的文件夹**，推荐取名为 Blog 即可
   ...
   <br>
 <img src="https://fastly.jsdelivr.net/gh/TommyZeng777/picgo/img/202203250926702.png" style="zoom: 33%;" />
> win11 因为右键菜单改了，需要请点击下方显示更多选项后才会显示
>
> <img src="https://fastly.jsdelivr.net/gh/TommyZeng777/picgo/img/202203250925906.png" style="zoom: 47%;" />
...
![](https://fastly.jsdelivr.net/gh/TommyZeng777/picgo/img/202203250938209.png)
